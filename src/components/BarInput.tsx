  ...
  return (
    ...
    >
      <div
        className={cn(
          animationDuration75,
          "peer col-span-full row-span-full flex h-[44px] w-[100px] justify-between rounded-xl pb-[2px] outline outline-2 -outline-offset-2 outline-transparent dark:outline dark:outline-2 dark:-outline-offset-2 dark:outline-white/40",
          {
