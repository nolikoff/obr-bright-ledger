...
export default function BarInput({
  ...
  valueName: ItemMetadataName;
  maxName: ItemMetadataName;
  ...
  return (
    ...
    >
      <div
        className={cn(
          animationDuration75,
          "peer col-span-full row-span-full flex h-[44px] w-[100px] justify-between rounded-xl pb-[2px] outline-0 outline outline-2 -outline-offset-2 outline-transparent dark:outline dark:outline-2 dark:-outline-offset-2 dark:outline-white/40",
          {
            "bg-stat-red/10 fill-stat-red/25 dark:bg-stat-red-dark/10 dark:fill-stat-red-dark/20 focus-within:outline-stat-red-highlight dark:focus-within:outline-stat-red-highlight-dark":
              color === "RED",
          },
          {
            "focus-within:outline-[#CC5A48]": color === "RED" && themeMode === "LIGHT",
          },
        )}
      >
